...
$(PROG): $(SRC)
	 $(CC) $(CFLAGS) $(COPTIMIZATION) -o $(PROG) $(SRC) $(OPENCV) $(I_ARRAY) $(L_ARRAY) $(I_HANDLE3DDATASETS) $(I_QUALITYASSESSMENT) $(I_CPUTIME) $(L_HANDLE3DDATASETS) $(L_QUALITYASSESSMENT) $(L_CPUTIME)
